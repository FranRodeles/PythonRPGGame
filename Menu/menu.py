...
class Menu:
    ...
    def _print_options(self):
        lines = []
        for idx in sorted(self.options.keys()):  #Verificar en que opcion esta, si esta en una opcion ponerle un diseño distinto al resto
            ...
            if idx == self.current_option:
                ...
                lines.append(label)
        options_text = "\n".join(lines)
        self.console.print(                # Panel de opciones
            Panel(
